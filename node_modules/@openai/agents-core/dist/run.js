...
class Runner extends lifecycle_1.RunHooks {
            ...
            try {
                while (true) {
                    ...
                    if (state._currentStep.type === 'next_step_run_again') {
                        ...
                        const processedResponse = await (0, modelOutputs_1.processModelResponseAsync)(state._lastTurnResponse, state._currentAgent, preparedCall.tools, preparedCall.handoffs, state, [...preparedCall.turnInput, ...state._generatedItems]);
        ...
        try {
            while (true) {
                ...
                if (result.state._currentStep.type === 'next_step_run_again') {
                    ...
                    const processedResponse = await (0, modelOutputs_1.processModelResponseAsync)(result.state._lastTurnResponse, currentAgent, preparedCall.tools, preparedCall.handoffs, result.state, [...preparedCall.turnInput, ...result.state._generatedItems]);
    ...
    async #prepareModelCall(state, options, artifacts, turnInput, serverConversationTracker, sessionInputUpdate) {
        ...
        let modelSettings = (0, modelSettings_1.mergeModelSettings)(this.config.modelSettings, state._currentAgent.modelSettings);
